...
const config = {
  ...
  //BotName
  inviteLink:
    "https://discord.com/api/oauth2/authorize?client_id=1055065257913090068&permissions=8&scope=bot%20applications.commands",
  //BotInvite Link
  Features: [
    {
      name: "Moderation",
  ...
  availableCommand: Coming Soon, //---   - Here
  ...
  discordLink: "https://discord.gg/RASsS779",
